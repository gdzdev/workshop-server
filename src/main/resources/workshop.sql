...
-- Insertar compras de prueba (estas serán inicialmente sin items de carrito asociados)
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Coca-Cola", 15, 0.1, 450.75, "2025-05-20", "2025-05-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Nestlé", 5, 0.05, 120.00, "2025-04-15", "2025-04-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Unilever", 20, 0.15, 700.50, "2025-03-10", "2025-03-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("PepsiCo", 10, 0.2, 300.00, "2025-02-28", "2025-02-28");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Procter & Gamble", 8, 0.12, 250.25, "2025-01-05", "2025-01-05");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Microsoft", 2, 0.03, 1200.00, "2024-12-01", "2024-12-01");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Apple", 1, 0.01, 1500.00, "2024-11-11", "2024-11-11");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Samsung", 3, 0.07, 800.00, "2024-10-20", "2024-10-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Sony", 7, 0.18, 400.00, "2024-09-01", "2024-09-01");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("LG", 12, 0.25, 600.00, "2024-08-14", "2024-08-14");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Adidas", 6, 0.09, 350.00, "2024-07-22", "2024-07-22");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Nike", 9, 0.11, 550.00, "2024-06-05", "2024-06-05");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Dell", 4, 0.06, 900.00, "2023-05-18", "2023-05-18");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("HP", 11, 0.13, 750.00, "2023-04-03", "2023-04-03");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Lenovo", 18, 0.17, 1100.00, "2023-03-25", "2023-03-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Amazon", 25, 0.3, 1500.00, "2023-02-14", "2023-02-14");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Google", 1, 0.02, 2000.00, "2023-01-01", "2023-01-01");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Meta", 2, 0.04, 1800.00, "2022-12-31", "2022-12-31");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Netflix", 3, 0.08, 250.00, "2022-11-2", "2022-11-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Disney", 5, 0.1, 400.00, "2022-10-07", "2022-10-07");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Dell", 15, 0.10, 850.00, "2025-05-23", "2025-05-23");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("HP", 10, 0.05, 600.00, "2025-05-22", "2025-05-22");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Lenovo", 20, 0.12, 1100.00, "2025-05-21", "2025-05-21");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Asus", 8, 0.08, 720.00, "2025-05-20", "2025-05-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Acer", 12, 0.07, 550.00, "2025-05-19", "2025-05-19");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("MSI", 5, 0.15, 950.00, "2025-05-18", "2025-05-18");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Razer", 3, 0.20, 1200.00, "2025-05-17", "2025-05-17");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Logitech", 25, 0.03, 300.00, "2025-05-16", "2025-05-16");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Corsair", 7, 0.10, 450.00, "2025-05-15", "2025-05-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("HyperX", 18, 0.06, 280.00, "2025-05-14", "2025-05-14");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Seagate", 10, 0.09, 150.00, "2025-04-30", "2025-04-30");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Western Digital", 14, 0.04, 180.00, "2025-04-25", "2025-04-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Crucial", 6, 0.11, 100.00, "2025-04-20", "2025-04-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Kingston", 22, 0.02, 80.00, "2025-04-15", "2025-04-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Samsung", 9, 0.08, 250.00, "2025-04-10", "2025-04-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Intel", 4, 0.15, 700.00, "2025-03-28", "2025-03-28");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("AMD", 7, 0.12, 600.00, "2025-03-20", "2025-03-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("NVIDIA", 2, 0.25, 1500.00, "2025-03-15", "2025-03-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("TP-Link", 30, 0.05, 120.00, "2025-03-10", "2025-03-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Netgear", 11, 0.10, 200.00, "2025-03-05", "2025-03-05");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("D-Link", 16, 0.07, 150.00, "2025-02-28", "2025-02-28");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Cisco", 1, 0.30, 2000.00, "2025-02-20", "2025-02-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Ubiquiti", 5, 0.18, 500.00, "2025-02-15", "2025-02-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Canon", 8, 0.10, 300.00, "2025-02-10", "2025-02-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Epson", 13, 0.06, 250.00, "2025-02-05", "2025-02-05");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("HP Inc.", 17, 0.09, 400.00, "2025-01-31", "2025-01-31");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Brother", 6, 0.04, 180.00, "2025-01-25", "2025-01-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Xerox", 2, 0.22, 900.00, "2025-01-20", "2025-01-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Lexmark", 9, 0.13, 350.00, "2025-01-15", "2025-01-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Ricoh", 4, 0.17, 600.00, "2025-01-10", "2025-01-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Panasonic", 10, 0.08, 280.00, "2024-12-31", "2024-12-31");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Sony", 7, 0.11, 500.00, "2024-12-25", "2024-12-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("LG", 12, 0.06, 400.00, "2024-12-20", "2024-12-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Philips", 18, 0.03, 150.00, "2024-12-15", "2024-12-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Bose", 3, 0.19, 700.00, "2024-12-10", "2024-12-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("JBL", 20, 0.07, 250.00, "2024-12-05", "2024-12-05");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Harman Kardon", 5, 0.14, 600.00, "2024-11-30", "2024-11-30");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Sennheiser", 8, 0.16, 450.00, "2024-11-25", "2024-11-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Audio-Technica", 11, 0.09, 320.00, "2024-11-20", "2024-11-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Shure", 6, 0.12, 550.00, "2024-11-15", "2024-11-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Blue Microphones", 4, 0.20, 380.00, "2024-10-31", "2024-10-31");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Rode", 7, 0.13, 420.00, "2024-10-25", "2024-10-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Zoom", 9, 0.08, 200.00, "2024-10-20", "2024-10-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("GoPro", 1, 0.25, 300.00, "2024-10-15", "2024-10-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("DJI", 2, 0.30, 800.00, "2024-10-10", "2024-10-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Garmin", 5, 0.15, 350.00, "2024-09-30", "2024-09-30");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Fitbit", 10, 0.10, 180.00, "2024-09-25", "2024-09-25");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Polar", 8, 0.12, 220.00, "2024-09-20", "2024-09-20");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Xiaomi", 15, 0.05, 100.00, "2024-09-15", "2024-09-15");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("OnePlus", 6, 0.07, 600.00, "2024-09-10", "2024-09-10");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Apple", 5, 0.10, 1500.00, "2025-05-24", "2025-05-24");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Google", 2, 0.05, 1200.00, "2025-05-24", "2025-05-24");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Microsoft", 3, 0.08, 900.00, "2025-05-24", "2025-05-24");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Amazon", 10, 0.12, 750.00, "2025-05-24", "2025-05-24");
INSERT INTO purchases(provider, count, discount, total_price, created_at, updated_at) values ("Meta", 1, 0.15, 2000.00, "2025-05-24", "2025-05-24");